...
<template>
  <view>
    ...
    <view v-if="state.showShareGuide" class="guide-wrap">
      <image class="guide-image" :src="yu.$url.static('/static/img/shop/share/share_guide.png')" />
    </view>
    ...
    <su-popup :show="show" round="10" :showClose="false" @close="closeShareModal">
      ...
      <view class="share-box">
        <view class="share-list-box ss-flex">
          ...
          >
            <image class="share-img" :src="yu.$url.static('/static/img/shop/share/share_wx.png')" mode="" />
          ...
          >
            <image
              class="share-img"
              :src="yu.$url.static('/static/img/shop/share/share_poster.png')"
              mode=""
            />
          ...
          >
            <image class="share-img" :src="yu.$url.static('/static/img/shop/share/share_link.png')" mode="" />
...
import { closeShareModal, showAuthModal } from '@yu/hooks/useModal'

const modalStore = yu.$store.useModalStore()
const app = yu.$store.useAppStore()
const user = yu.$store.useUserStore()
const show = computed(() => modalStore.share)
const shareConfig = computed(() => app.platform.share)
...
const onShareByCopyLink = () => {
  yu.$helper.copyText(props.shareInfo.link)
  closeShareModal()
}
